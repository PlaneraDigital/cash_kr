...
const devices = [
  ...
  mkDevice({
    ...
    processorFamily: 'Apple M4 Pro', generation: 'M-Series', tier: 'Premium',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/23/10/apple-macbook-pro-m3/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/20/11/apple-macbook-air-pro-mini-m1/gsmarena_002.jpg",
    variants: [{ basePrice: 36000 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'Macbook Air 2026', slug: 'apple-macbook-air-2026',
    processorFamily: 'Apple M4 Pro', generation: 'M-Series', tier: 'Premium',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/24/03/apple-macbook-air-m3/gsmarena_002.jpg",
    variants: [{ basePrice: 70000 }],
  }),
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/23/10/apple-macbook-pro-m3/gsmarena_002.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/23/01/apple-macbook-pro-14-16-m2/gsmarena_001.jpg",
    variants: [{ basePrice: 70000 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Pro 2022', slug: 'apple-macbook-pro-2022',
    processorFamily: 'Apple M2', generation: 'M-Series', tier: 'Premium',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/22/06/wwdc-hardware/gsmarena_002.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/20/05/apple-macbook-pro-13-intel-refresh/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/21/10/apple-macbook-pro-2021/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/20/05/apple-macbook-pro-13-intel-refresh/gsmarena_002.jpg",
    variants: [{ basePrice: 35450 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Pro 2020', slug: 'apple-macbook-pro-2020',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/20/11/apple-macbook-air-pro-mini-m1/gsmarena_003.jpg",
    variants: [{ basePrice: 42000 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Pro 2019', slug: 'apple-macbook-pro-2019',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/19/11/apple-macbook-pro-16-inch/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/19/05/apple-macbook-pro-refresh/gsmarena_001.jpg",
    variants: [{ basePrice: 35450 }],
  }),
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/19/05/apple-macbook-pro-refresh/gsmarena_002.jpg",
    variants: [{ basePrice: 33310 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Pro 2019 (Touch Bar)', slug: 'apple-macbook-pro-2019-touch-bar',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/19/11/apple-macbook-pro-16-inch/gsmarena_002.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/18/07/apple-macbook-pro-2018/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/16/10/apple-macbook-pro/gsmarena_002.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/16/10/apple-macbook-pro/gsmarena_003.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/16/10/apple-macbook-pro/gsmarena_001.jpg",
    variants: [{ basePrice: 27860 }],
  }),
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/16/10/apple-macbook-pro/gsmarena_004.jpg",
    variants: [{ basePrice: 25320 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Pro Retina Mid 2015', slug: 'apple-macbook-pro-retina-mid-2015',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/15/03/apple-event/gsmarena_002.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Apple M2', generation: 'M-Series', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/23/06/apple-macbook-air-15/gsmarena_001.jpg",
    variants: [{ basePrice: 54350 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Air 2022', slug: 'apple-macbook-air-2022',
    processorFamily: 'Apple M2', generation: 'M-Series', tier: 'Mid-range',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/22/06/wwdc-hardware/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/20/11/apple-macbook-air-pro-mini-m1/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/24/03/apple-macbook-air-m3/gsmarena_001.jpg",
    variants: [{ basePrice: 60000 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Air 2019', slug: 'apple-macbook-air-2019',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/18/10/apple-october-30-event/gsmarena_002.jpg",
    variants: [{ basePrice: 26750 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Air 2018', slug: 'apple-macbook-air-2018',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/18/10/apple-october-30-event/gsmarena_001.jpg",
    variants: [{ basePrice: 23030 }],
  }),
  mkDevice({
    brand: 'Apple', modelName: 'MacBook Air Mid 2017', slug: 'apple-macbook-air-mid-2017',
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/15/03/apple-event/gsmarena_001.jpg",
  ...
  mkDevice({
    ...
    processorFamily: 'Intel Core i5', generation: 'Intel', tier: 'Budget',
    imageUrl: "https://fdn2.gsmarena.com/vv/newsimg/15/03/apple-event/gsmarena_003.jpg",
