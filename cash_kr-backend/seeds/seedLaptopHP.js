...
const devices = [
  mkDevice({
    brand: 'HP', modelName: 'HP Spectre x360 14 (2024)', slug: 'hp-spectre-x360-14-2024',
    processorFamily: 'Intel Core Ultra 7', generation: 'Ultra Gen', tier: 'Premium',
    variants: [
      { ram: '16GB', storage: '512GB SSD', basePrice: 78000 },
      { ram: '16GB', storage: '1TB SSD', basePrice: 88000 },
      { ram: '32GB', storage: '1TB SSD', basePrice: 105000 },
    ],
  }),
  mkDevice({
    brand: 'HP', modelName: 'HP Spectre x360 16 (2024)', slug: 'hp-spectre-x360-16-2024',
    processorFamily: 'Intel Core Ultra 9', generation: 'Ultra Gen', tier: 'Premium',
    variants: [
      { ram: '32GB', storage: '1TB SSD', basePrice: 118000 },
      { ram: '64GB', storage: '2TB SSD', basePrice: 148000 },
    ],
  }),
  mkDevice({
    brand: 'HP', modelName: 'HP Envy 16 (2024)', slug: 'hp-envy-16-2024',
  ...
  mkDevice({
    brand: 'HP', modelName: 'HP Pavilion 15 (2024)', slug: 'hp-pavilion-15-2024',
  ...
  mkDevice({
    brand: 'HP', modelName: 'HP 15s (2024)', slug: 'hp-15s-2024',
  ...
  mkDevice({
    brand: 'HP', modelName: 'HP Omen 16 (2024)', slug: 'hp-omen-16-2024',
    processorFamily: 'Intel Core i7', generation: '13th Gen', tier: 'Gaming',
    gpuType: 'NVIDIA RTX 4070', isGaming: true,
    variants: [
      { ram: '16GB', storage: '512GB SSD', basePrice: 92000 },
      { ram: '32GB', storage: '1TB SSD', basePrice: 110000 },
    ],
  }),
  mkDevice({
    brand: 'HP', modelName: 'HP Victus 16 (2024)', slug: 'hp-victus-16-2024',
    ...
    variants: [
      ...
      { ram: '16GB', storage: '1TB SSD', basePrice: 62000 },
    ],
  }),
];
